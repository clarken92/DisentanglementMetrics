...
for num_samples in [10000]:  # [100000, 30000, 3000, 1000]:
    for run_id in run_ids:
        output_dir = abspath(join(RESULTS_DIR, "dSprites", "FactorVAE", enc_dec_model, run_id))
        save_dir = abspath(join(RESULTS_DIR, "dSprites", "FactorVAE", "auxiliary", "SEP"))
        gpu = 0
        ...
        run_command = "{} ./12a_SEP_sampling.py {}".format(PYTHON_EXE, arg_str).strip()
