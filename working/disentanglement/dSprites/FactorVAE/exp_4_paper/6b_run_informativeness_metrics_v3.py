...
save_dir = abspath(join(RESULTS_DIR, "dSprites", "FactorVAE", "auxiliary", "informativeness_metrics_v3"))
...
run_command = "{} ./6a_informativeness_metrics_v3.py {}".format(PYTHON_EXE, arg_str).strip()
