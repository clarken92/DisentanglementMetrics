...
def main():
    ...
    save_dir = abspath(join(RESULTS_DIR, "dSprites", "FactorVAE", "auxiliary", "plot_independence_heatmap",
                            "{}_{}".format(enc_dec_model, run_id)))

    independence_metrics_dir = abspath(join(RESULTS_DIR, "dSprites", "FactorVAE",
        "auxiliary", "independence_metrics", "{}_{}".format(enc_dec_model, run_id)))
