...
# Different from the old version 1, this version handle situation when
# the maximum stddev of p(z|x) << bin width.
# In this case, we have p(z|x) of this particular bin is 1 and other bin is 0
def main(args):
    # =====================================
    # Load config
    # =====================================
