...
def main():
    ...
    run_id = "6_VAE_beta50"
    # run_id = "8_VAE"
    save_dir = abspath(join(RESULTS_DIR, "celebA", "FactorVAE", "auxiliary", "plot_independence_hitmap",
                            "FactorVAE_{}".format(run_id)))

    independence_metrics_dir = abspath(join(RESULTS_DIR, "celebA", "FactorVAE",
        "auxiliary", "independence_metrics", "FactorVAE_{}".format(run_id)))
