...
def plot_curve():
    ...
    file_names = ['run_1Konny_0_default_summary_tf-tag-train_kld_loss.csv',
                  'run_1Konny_1_tc50_multiSave_summary_tf-tag-train_kld_loss.csv',
                  ]
    ...
    pp = PdfPages(join(save_dir, 'kld_curve.pdf'))
    pp.savefig(plt.gcf())
    pp.close()
    plt.close()
